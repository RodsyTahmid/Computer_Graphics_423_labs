...
def Convert_To_Zero(Zone, X, Y): #Converting original zone to zone-0 #zone-2 to zone-0
    if Zone == 0:
        return X, Y
    elif Zone == 1:
        return Y, X
...
def WritePixel(x1, y1, x2, y2):
    ...
    m1, n1 = Convert_To_Zero(Zone, x1, y1) #point 1
    m2, n2 = Convert_To_Zero(Zone, x2, y2) #point 2
